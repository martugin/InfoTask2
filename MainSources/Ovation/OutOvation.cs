...
namespace Provider
{
    ...
    internal class OutOvation : SourceOut
    {
        internal OutOvation(OvationSource source, int id) : base(source)
        {
            Id = id;
        }
        ...
        private ErrMom ReadError(double? fValue, int? rawValue, int? sts)
        {
