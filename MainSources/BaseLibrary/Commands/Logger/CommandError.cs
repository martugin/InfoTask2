...
namespace BaseLibrary
{
    ...
    {
        internal CommandError(string text, Exception ex = null, string par = "", string context = "", CommandQuality quality = CommandQuality.Error)
        {
            Text = text;
            Params = par;
            Exeption = ex;
        ...
        public bool EqualsTo(CommandError err)
        {
