...
namespace BaseLibrary
{
    ...
    public class ReaderAdo : IRecordRead
    {
        ...
        public ReaderAdo(SqlProps props, string stSql, int timeout = 120)
        {
            _useDb = false;
            _props = props;
        ...
        public ReaderAdo(OleDbConnection con, string stSql, params OleDbParameter[] pars)
        {
            ...
            OpenReader(stSql, con,  120, pars);
        }

        private void OpenReader(string stSql, IDbConnection con, int timeout = 120, params OleDbParameter[] pars)
        {
        ...
        {
            return DBNull.Value.Equals(Reader[num]);
        }

        //Копирует значение поля field таблицы rec в ячейку gridField, строки cells, датагрида WinForms
