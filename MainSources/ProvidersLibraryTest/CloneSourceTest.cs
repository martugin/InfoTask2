...
namespace ProvidersLibraryTest
{
    ...
    public class CloneSourceTest
    {
        ...
        {
            var source = MakeCloneSource();
            var sig = source.AddInitialSignal("Ob.SigB", "Ob", DataType.Boolean, "");
            ...
            sig = source.AddInitialSignal("Ob.SigI", "Ob", DataType.Integer, "");
            ...
            sig = source.AddInitialSignal("Ob.SigR", "Ob", DataType.Real, "");
            ...
            sig = source.AddInitialSignal("Ob.SigS", "Ob", DataType.String, "");
            ...
            sig = source.AddInitialSignal("Ob.SigT", "Ob", DataType.Time, "");
            ...
            source.AddInitialSignal("ObConst.SigB", "ObConst", DataType.Boolean, "");
            source.AddInitialSignal("ObConst.SigI", "ObConst", DataType.Integer, "");
            source.AddInitialSignal("ObConst.SigR", "ObConst", DataType.Real, "");
            source.AddInitialSignal("ObConst.SigS", "ObConst", DataType.String, "");
