...
namespace InfoTaskClientTest
{
    ...
    public class ItClientTest
    {
        ...
        public void Run()
        {
            ...
            ind.Compare(1, "BeginPeriod", "01.01.2017 10:00:00");
            ind.Compare(2, "EndPeriod", "01.01.2017 11:00:00");
            ind.Compare(3, "ModePeriod");
            ...
            ind.Compare(41, "BeginPeriod", "01.01.2017 11:00:00");
            ind.Compare(42, "EndPeriod", "01.01.2017 12:00:00");
            ind.Compare(43, "ModePeriod", "Mode");
