...
namespace GeneratorTest
{
    ...
    public class RealisationScalarTest
    {
        ...
        private IReadMean Calc(GenFunctions funs, string funName, DataType dtype, params IReadMean[] pars)
        {
        ...
        {
            var funs = new GenFunctions();
            IReadMean i1 = new IntMean(21), i2 = new IntMean(2), i3 = new IntMean(0), i4 = new IntMean(3);

            var c = (ConstGenFun)(funs.CurFun = funs.Funs["TrueFun_"]);
            var m = c.Calculate(new IReadMean[0], DataType.Boolean);
            Assert.IsTrue(m.Boolean);
            c = (ConstGenFun)(funs.CurFun = funs.Funs["FalseFun_"]);
            m = c.Calculate(new IReadMean[0], DataType.Boolean);
            Assert.IsFalse(m.Boolean);
         ...
         {
             var funs = new GenFunctions();
             IReadMean r1 = new RealMean(2.345), r2 = new RealMean(-1.234);
             IReadMean i1 = new IntMean(2), r3 = new RealMean(0);
             ...
             m = c.Calculate(new IReadMean[0], DataType.Real);
             Assert.AreEqual(Math.PI, m.Real);

             IReadMean r5 = new RealMean(0.789), r6 = new RealMean(-Math.PI/2), r7 = new IntMean(-1);
        ...
        {
            var funs = new GenFunctions();
            IReadMean s1 = new StringMean("1"), s2 = new StringMean("-5"), s3 = new StringMean("23.456"), s4 = new StringMean("10.10.2010 10:10:10");
            IReadMean r1 = new RealMean(-0.1), i1 = new IntMean(0);
        ...
        {
            var funs = new GenFunctions();
            IReadMean s1 = new StringMean(" AbAb AA  "), s2 = new StringMean("123Ab34 "), s3 = new StringMean(""), s4 = new StringMean(null);

            var c = (ConstGenFun)(funs.CurFun = funs.Funs["NewLine_"]);
            IReadMean m = c.Calculate(new IReadMean[0], DataType.String);
            ...
            IReadMean i1 = new IntMean(3), i2 = new IntMean(0), i3 = new IntMean(5), i4 = new IntMean(-3);
            ...
            IReadMean s5 = new StringMean("Ab"), s6 = new StringMean("AA");
            ...
            IReadMean s7 = new StringMean(".*Ab.*"), s8 = new StringMean("A.?");
