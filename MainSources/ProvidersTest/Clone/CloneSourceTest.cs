...
namespace ProvidersTest
{
    ...
    public class CloneSourceTest
    {
        ...
        public void FullRead()
        {
            ...
            var sig = connect.AddInitialSignal("Ob.SigB", DataType.Boolean, "Ob.SigB", "", "", true);
            ...
            sig = connect.AddInitialSignal("Ob.SigI", DataType.Integer, "Ob.SigI", "", "", true);
            ...
            sig = connect.AddInitialSignal("Ob.SigR", DataType.Real, "Ob.SigR", "", "", true);
            ...
            sig = connect.AddInitialSignal("Ob.SigS", DataType.String, "Ob.SigS", "", "", true);
            ...
            sig = connect.AddInitialSignal("Ob.SigT", DataType.Time, "Ob.SigT", "", "", true);
            ...
            connect.AddInitialSignal("ObConst.SigB", DataType.Boolean, "ObConst.SigB", "", "", true);
            connect.AddInitialSignal("ObConst.SigI", DataType.Integer, "ObConst.SigI", "", "", true);
            connect.AddInitialSignal("ObConst.SigR", DataType.Real, "ObConst.SigR", "", "", true);
            connect.AddInitialSignal("ObConst.SigS", DataType.String, "ObConst.SigS", "", "", true);
